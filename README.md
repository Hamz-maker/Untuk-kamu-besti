...
<title>Special Message — Onedev</title>
...
<div id="env-stage">
  ...
  <p style="margin-top:25px; font-weight:900; color:var(--black); font-family:var(--mono);">BUAT KAMU 🩷</p>
</div>

<div class="container" id="stageMsg">
  <div class="msg-text" id="typewriter"></div>
  <div class="switch-box" id="musicToggle">
    <p style="font-size: 13px; font-weight: 900; color: #666;">On in dulu tombol ini👇:</p>
  ...
  <button class="btn-style btn-accent" id="nextBtn" onclick="flow()" style="display:none">LANJUT ⮕</button>
</div>
...
<div class="container" id="gameNyebelin">
  ...
  <div id="q-options">
    <button class="btn-style btn-accent" id="ansBtn" onclick="ansBenar()">Pastinya Kamu ️🗿</button>
...
<div class="container" id="gameFinal">
  ...
  <p style="font-size: 18px;"><b>Will you be my Valentine? ❤️</b></p>
  <div style="position:relative; height:150px; margin-top:25px;">
    <button class="btn-style" id="yesBtn" onclick="finish()">MAU BANGET! 😍</button>
...
<div class="container" id="stageWA">
  ...
  <button class="btn-style btn-wa" onclick="kirimWA()">Kirim Kasih Sayang ❤️</button>
</div>
...
let step = 0;
const messages = ["Haii, Cieee dapet surat nih🙈", "Makasih udah mau bertahan sejauh ini sama aku.", "Kamu itu rumah, tempat aku pulang paling nyaman.", "Ikutin misi ini, tolong jujur jawabnya besti❤..."];
...
function ansBenar() {
  ...
  if(qStep === 2) {
    ...
    btnBetul.innerText = "Punya siapa hayo! 👩‍❤️‍👨"; // Teks tombol baru
    ...
    btnBetul.innerText = "Janji Besti! 💖"; // Teks tombol baru
...
function finish() {
  ...
  document.getElementById('gameFinal').innerHTML = `
    <h2 style="color:var(--accent)">I LOVE YOU BESTII! ❤️</h2>
...
function kirimWA() {
  ...
  const pesan = encodeURIComponent("I LOVE YOU BESTI! ❤️");
